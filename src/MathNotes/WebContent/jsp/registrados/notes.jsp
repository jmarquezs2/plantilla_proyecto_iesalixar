	...
	<div class="row">
        ...
        <section class="col-12" id="fondoNotes">
            ...
            <section class="d-block d-md-none">
                ...
                <div class="row">
                    <h3 id="h3notes" class="mx-5 mb-0">Apuntes Guardados   <button  type="button" class="  btn btn-outline-dark   " data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1"><img src="../../img/icon/menu.png" id="menuimg" alt=""></button></h3>
