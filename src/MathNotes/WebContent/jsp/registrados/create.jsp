...
<div id="groupPublic">
                    ...
                    <!--<div class="form-group">
                     ...
                     <div class="form-group mb-5">
                        ...
                        <label class="col-5"  for="title">Título</label>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" class="col-7" id="inputWrite" name="subject" placeholder="Matemáticas, Física, Tecnología...">
                    </div>
                    </div>
                    <div class="form-group mb-5">
                        <div class="row">
                       ...
                       <input  class="col-7" type="text" id="inputWrite" name="temary" placeholder="Trigonometría, Fuerzas...">
                       </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                      <div class="card card-body">
                       <div class="row">
                        ...
                        <button  type="button" class="col-5 btn btn-outline-dark ml-2 mb-3 " >Apuntes Públicos</button>
                        <button  type="button" class="col-5 btn btn-outline-dark ml-4 mr-2" >Nuevo Apunte</button>
                        <button  type="button" class="col-5 btn btn-outline-dark ml-2" >Cambiar Contraseña</button>
                  ...
                  <form action="/MathNotes/Create" id="formCreate" method="post" enctype="multipart/form-data">
                    ...
                    <div id="groupPublic">
                                        ...
                                        <label class="mx-5">¿Hacer público?</label>
                                        <input type="radio" id="yes" name="visibility" value="y">
                                        <label for="">Si</label>
