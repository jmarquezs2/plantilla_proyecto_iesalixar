	...
	<div class="row">
        <header class="col-12">
            <div class="row">
                ...
                <button id="botonUp" class="col-md-2 offset-md-6 col-sm-4 col-4  bg-white  my-auto" onclick="location='Login'">Iniciar Sesión</button>
            </div>
        ...
        <h3 class="col-12 mt-5" id="h3index2">Empieza por aqui!</h3>
                    <form action="" class="col-12">
                      <div class="row">
                            ...
                            <button id="botonDown" class="col-12 bg-white  my-auto">Registrarse</button>
                        </div>
